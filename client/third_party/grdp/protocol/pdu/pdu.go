...
func NewPDULayer(t core.Transport) *PDULayer {
	p := &PDULayer{
		...
		clientCapabilities: map[CapsType]Capability{
			...
			CAPSETTYPE_SURFACE_COMMANDS: &SurfaceCommandsCapability{CmdFlags: SURFCMDS_SET_SURFACE_BITS |
				SURFCMDS_FRAME_MARKER |
				SURFCMDS_STREAM_SURFACE_BITS},
			CAPSSETTYPE_FRAME_ACKNOWLEDGE: &FrameAcknowledgeCapability{MaxUnacknowledgedFrameCount: 2},
